export type Country = {
  ...
  currency: string
  phone: string
  region: 'west-africa' | 'central-africa' | 'east-africa' | 'north-africa' | 'south-africa' | 'europe' | 'americas'
}

/**
 * Liste standardisée ISO 3166-1 alpha-2.
 * Afrique en priorité (marché principal IFE FOOD) + diaspora Europe/Amériques.
 * Triée : Afrique de l'Ouest → Centrale → Est → Nord → Australe → Europe → Amériques.
 */
export const COUNTRIES: Country[] = [
  ...
  { code: 'SL', name: 'Sierra Leone',       currency: 'SLL', phone: '+232', region: 'west-africa' },
  ...
  { code: 'ZW', name: 'Zimbabwe',           currency: 'ZWL', phone: '+263', region: 'east-africa' },
...
/** Groupes régionaux pour affichage optionnel en sections */
